...
class ApplicationManager:
    ...
    def launch(self, kill_existing: bool = True) -> None:
        ...
        logger.info(
            "Waiting %.1fs for application to start...",
    ...
    def close(self) -> None:
        ...
        if hwnd:
            logger.info("Sending WM_CLOSE to '%s'...", self.config.title)
    ...
    def force_close(self) -> None:
        """Force-kill the application process via taskkill."""
        logger.info("Force-closing: %s", self.config.process_name)
